...
task(`deploy:gov-no-delay`, `Deploy governance for tests and development purposes`)
  .addFlag('verify')
  .addParam('strategy', '', ZERO_ADDRESS)
  .addParam('votingDelay', '', '0') // needed to be increase, evm_revert does not update block
